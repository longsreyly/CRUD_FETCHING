  ...
  return (
    <main>
      ...
      <div className="relative mb-4">
        ...
        <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-blue-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-blue-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Search by name..."  value={searchTerm}  onChange={(e) => setSearchTerm(e.target.value)}  />
      </div>
        ...
        <table className="w-full table-fixed">
          ...
          <tbody className="bg-white">
            {currentItems.length > 0 ? (
              ...
              <tr>
                <td  colSpan="4"   className="text-center py-4 text-gray-500 font-medium" >  No data found </td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <div className="flex justify-center mt-4">
        <button  onClick={() => handlePageChange(currentPage - 1)}  disabled={currentPage === 1} className="px-2 py-2 mx-1 text-sm font-semibold text-white bg-blue-500 rounded hover:bg-blue-600">  Previous </button>
