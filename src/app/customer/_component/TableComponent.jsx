        ...
        <main>
            ...
            <div className="relative mb-4">
                ...
                <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-blue-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-blue-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Search by name..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
            </div>
                                ...
                                <tr key={data.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="d-flex ">
                                            ...
                                            <button onClick={() => onDeleteCustomer(data.id)} className="py-1 px-3 text-sm text-white bg-red-500 rounded hover:bg-red-600">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            ))
            ...
            <div className="flex justify-center mt-4">
                ...
                {Array.from({ length: totalPages }, (_, index) => (
                    <button
                        ...
                        className={`px-4 py-2 mx-1 text-sm font-semibold ${currentPage === index + 1 ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'} rounded hover:bg-blue-600`}
                    >
                        {index + 1}
                    </button>
                ))}
