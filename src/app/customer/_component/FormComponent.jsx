      ...
      <div className="mt-7 bg-white rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 border-2 border-indigo-300">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">  {customer ? "Edit Customer" : "Add Customer"}  </h1>
          </div>
          <div className="mt-5">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid gap-y-4">
                ...
                <div>
                  ...
                  <input id="customerName"  type="text" {...register("customerName", {required: "Customer name is required",minLength: {value: 3,message: "Name must be at least 3 characters",  },  })}  className="input input-bordered input-primary w-full max-w-xs"  style={{ border: "1px solid", borderRadius: "5px" }}/>
                ...
                <div>
                  ...
                  <select id="gender"
                    {...register("gender", {required: "Please select gender", })} className="input input-bordered input-primary w-full max-w-xs" style={{ border: "1px solid", borderRadius: "5px" }} >
                ...
                <div>
                  ...
                  <input  id="address" type="text"
                    {...register("address", {required: "Address is required", })}  className="input input-bordered input-primary w-full max-w-xs"  style={{ border: "1px solid", borderRadius: "5px" }} />
