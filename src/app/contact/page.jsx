...
export default function ContactForm() {
  ...
  const onSubmit = (data) => {
    setStatus("Sending...");
    emailjs
      .send("service_gmp5fgs", "template_s5ax9fo", data, "T_7h1kANvpJqIY_xq")
      .then(() => {
    ...
    <section className="relative text-gray-700">
      ...
      >
        <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 relative z-10 w-full">
          ...
          <small className="text-gray-600 leading-relaxed mb-5">
            Post-ironic portland shabby chic echo park.
          </small>
